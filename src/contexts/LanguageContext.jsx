...
const translations = {
  pt: {
    ...
    haveWhatItTakes: 'Apenas para Mentes Brilhantes',
    only3PercentSolve: 'O Protocolo Paradox é um desafio para a elite intelectual. Aqueles que ousam e persistem, descobrem um mundo de recompensas sem igual.',
    ofPeople: '',
    solveChallenges: '',
    butThoseWhoDo: '',
    winLifeChangingPrizes: 'ganham prémios que transformam vidas.',
  ...
  en: {
    ...
    haveWhatItTakes: 'Only for Brilliant Minds',
    only3PercentSolve: 'The Paradox Protocol is a challenge for the intellectual elite. Those who dare and persist, discover a world of unparalleled rewards.',
    ofPeople: '',
    solveChallenges: '',
    butThoseWhoDo: '',
  ...
  es: {
    ...
    haveWhatItTakes: "Solo para Mentes Brillantes",
    only3PercentSolve: "El Protocolo Paradox es un desafío para la élite intelectual. Aquellos que se atreven y persisten, descubren un mundo de recompensas sin igual.",
    ofPeople: ",
    solveChallenges: ",
    butThoseWhoDo: ",
  ...
  de: {
    ...
    haveWhatItTakes: "Nur für brillante Köpfe",
    only3PercentSolve: "Das Paradox-Protokoll ist eine Herausforderung für die intellektuelle Elite. Diejenigen, die wagen und durchhalten, entdecken eine Welt unvergleichlicher Belohnungen.",
    ofPeople: ",
    solveChallenges: ",
    butThoseWhoDo: ",
  ...
  fr: {
    ...
    testimonial2: '"Les défis sont incroyables et le support est fantastique. Je le recommande à tous ceux qui veulent tester leurs limites."',    haveWhatItTakes: "Seu Esprit Brillant",
    only3PercentSolve: "Le Protocole Paradoxe est un défi pour l'élite intellectuelle. Ceux qui osent et persistent découvrent un monde de récompenses inégalées.",
    ofPeople: ",
    solveChallenges: ",
    butThoseWhoDo: ",
