...
const translations = {
  pt: {
    ...
    haveWhatItTakes: 'Apenas alguns conseguem resolver os nossos desafios, mas aqueles que o fazem ganham prémios que mudam vidas.',
    only3PercentSolve: 'Apenas 3% das pessoas conseguem resolver os nossos desafios, mas aqueles que o fazem ganham prémios que mudam vidas.',
    ...
    solveForDiscount: 'Resolver para Desconto',
  ...
  en: {
    ...
    testimonial2: '"The challenges are incredible and the support is fantastic. I recommend it to everyone who wants to test their limits."',    haveWhatItTakes: 'Apenas alguns conseguem resolver os nossos desafios, mas aqueles que o fazem ganham prémios que mudam vidas.', it takes?',
  ...
  es: {
    ...
    // Hero Section
    heroTitle: 'Paradox Protocol - El Desafío de las Mentes Más Brillantes',
  ...
  fr: {
    ...
    intellectualExcellenceDesc: 'Nous valorisons la profondeur de la réflexion et la capacité à résoudre des problèmes complexes.',
    globalCommunity: 'Communauté Mondiale',
    globalCommunityDesc: 'Nous connectons des esprits brillants du monde entier dans un espace de collaboration et de défi mutuel.',
    constantInnovation: 'Innovation Constante',
    constantInnovationDesc: 'Nous faisons constamment évoluer nos défis pour tester les limites de la connaissance humaine.',
    fullTransparency: 'Transparence Totale',
    fullTransparencyDesc: 'Tous nos processus sont ouverts et auditables, garantissant l\'équité dans chaque défi.',
    drElenaVasquez: 'Dr. Elena Vasquez',
    founderPuzzleArchitect: 'Fondatrice & Architecte d\'Énigmes',
    drElenaVasquezDesc: 'Docteure en mathématiques et ancienne championne mondiale d\'énigmes, Elena a apporté sa passion pour les défis intellectuels pour créer Paradox Protocol.',
    marcusChen: 'Marcus Chen',
    cto: 'Directeur Technique',
    marcusChenDesc: 'Expert en cybersécurité et systèmes distribués, Marcus garantit l\'intégrité et la sécurité de notre plateforme.',
    sofiaAndersson: 'Sofia Andersson',
    cognitivePsychologist: 'Psychologue Cognitive',
    sofiaAnderssonDesc: 'Avec des recherches en résolution de problèmes complexes, Sofia conçoit des défis qui testent vraiment les limites de l\'esprit.',
    aboutHeroTitle: 'À Propos de Paradox Protocol',
    aboutHeroSubtitle: 'Une révolution dans la façon dont nous défions et récompensons l\'intelligence humaine',
    ourMission: 'Notre Mission',
    ourMissionDesc: 'Créer des défis intellectuels qui testent les limites de l\'esprit humain, offrant des récompenses proportionnelles à l\'effort et aux capacités démontrées.',
    whoWeAre: 'Qui Nous Sommes',
    whoWeAreDesc: 'Une équipe multidisciplinaire d\'experts passionnés par les défis intellectuels et la construction d\'une communauté mondiale d\'esprits brillants.',
    ourPhilosophy: 'Notre Philosophie',
    ourPhilosophyDesc: 'Nous croyons que la véritable intelligence mérite d\'être reconnue et récompensée. Paradox Protocol a été fondé sur la conviction que le mérite, la transparence et l\'excellence doivent être les piliers de toute initiative qui vise à défier l\'esprit humain. Nous rejetons tout élément de chance ou de hasard - le succès sur notre plateforme est une réalisation purement intellectuelle.',
    yourJourneyBegins: 'Votre Voyage Commence',
    yourJourneyBeginsDesc: 'Quel que soit votre niveau d\'expérience, Paradox Protocol propose des défis qui testeront vos limites et récompenseront votre intellect. Rejoignez une communauté mondiale de résolveurs de problèmes et commencez votre ascension dans l\'élite intellectuelle.',
    areYouReady: 'Êtes-vous Prêt?',
    yourJourneyBeginsNow: 'Votre voyage parmi les esprits les plus brillants du monde commence maintenant.',
